...
export function getExactTopicImage(headline: string = '', categoryId: string = 'national'): string {
  ...
  if (t.includes('জাতিসংঘ') || t.includes('নিরাপত্তা পরিষদ') || t.includes('সাধারণ পরিষদ') || t.includes('un security') || t.includes('united nations')) {
    return 'https://images.unsplash.com/photo-1526470608268-f674ce90ebd4?w=1200&auto=format&fit=crop&q=80'; // UN assembly hall
  }
  if (t.includes('গাজা') || t.includes('ফিলিস্তিন') || t.includes('ইসরায়েল') || t.includes('যুদ্ধবিরতি') || t.includes('রাফা') || t.includes('peace agreement')) {
    return 'https://images.unsplash.com/photo-1579830341097-440d90d81024?w=1200&auto=format&fit=crop&q=80'; // peace & humanitarian
  }
  if (t.includes('হোয়াইট হাউস') || t.includes('যুক্তরাষ্ট্র') || t.includes('বাইডেন') || t.includes('ট্রাম্প') || t.includes('কংগ্রেস') || t.includes('washington') || t.includes('white house')) {
    return 'https://images.unsplash.com/photo-1541872703-74c5e44368f9?w=1200&auto=format&fit=crop&q=80'; // Washington Capitol / White House diplomacy
  }
  if (t.includes('ইউক্রেন') || t.includes('রাশিয়া') || t.includes('পুতিন') || t.includes('জেলেনস্কি') || t.includes('ন্যাটো') || t.includes('nato')) {
    return 'https://images.unsplash.com/photo-1517048676732-d65bc937f952?w=1200&auto=format&fit=crop&q=80'; // International summit meeting
  }
  if (t.includes('চীন') || t.includes('বেইজিং') || t.includes('china') || t.includes('জিনপিং')) {
    return 'https://images.unsplash.com/photo-1508804185872-d7badad00f7d?w=1200&auto=format&fit=crop&q=80'; // China city / diplomacy
  }
  if (t.includes('ভারত') || t.includes('দিল্লি') || t.includes('মোদি') || t.includes('india') || t.includes('সীমান্ত')) {
    return 'https://images.unsplash.com/photo-1532375810709-75b1da00537c?w=1200&auto=format&fit=crop&q=80'; // India monument / diplomacy
  }
  if (t.includes('জলবায়ু') || t.includes('কপ') || t.includes('কার্বন') || t.includes('পরিবেশ') || t.includes('climate') || t.includes('গ্লোবাল ওয়ার্মিং')) {
    return 'https://images.unsplash.com/photo-1569163139599-0f4517e36f51?w=1200&auto=format&fit=crop&q=80'; // Climate / Renewable energy
  }
  if (t.includes('মহাকাশ') || t.includes('নাসা') || t.includes('রকেট') || t.includes('স্যাটেলাইট') || t.includes('space') || t.includes('nasa')) {
    return 'https://images.unsplash.com/photo-1517976487507-5800f401f8f9?w=1200&auto=format&fit=crop&q=80'; // Space rocket
  }
  if (t.includes('লোহিত সাগর') || t.includes('জাহাজ') || t.includes('উপসাগর') || t.includes('পোর্ট') || t.includes('বন্দর') || t.includes('shipping')) {
    return 'https://images.unsplash.com/photo-1526304640581-d334cdbbf45e?w=1200&auto=format&fit=crop&q=80'; // Maritime shipping cargo
  }
  ...
  if (t.includes('রমজান') || t.includes('নিত্যপণ্য') || t.includes('বাজার') || t.includes('কারওয়ান') || t.includes('দ্রব্যমূল্য')) {
  ...
  if (t.includes('ফুটবল') || t.includes('সাফ') || t.includes('saff') || t.includes('নারী ফুটবল') || t.includes('মেসি') || t.includes('রোনালদো')) {
    return 'https://images.unsplash.com/photo-1574629810360-7efbbe195018?w=1200&auto=format&fit=crop&q=80'; // football victory
  }
  if (t.includes('সংসদ') || t.includes('নির্বাচন') || t.includes('সংস্কার') || t.includes('parliament') || t.includes('সংবিধান')) {
  ...
  if (t.includes('সাইবার') || t.includes('হ্যাকিং') || t.includes('cyber') || t.includes('নিরাপত্তা') || t.includes('সিকিউরিটি')) {
    return 'https://images.unsplash.com/photo-1550751827-4bd374c3f58b?w=1200&auto=format&fit=crop&q=80'; // cyber security
  }
  if (t.includes('রিজার্ভ') || t.includes('ডলার') || t.includes('তৈল') || t.includes('তেলের দাম') || t.includes('oil') || t.includes('আইএমএফ') || t.includes('বিশ্বব্যাংক')) {
    return 'https://images.unsplash.com/photo-1611974789855-9c2a0a7236a3?w=1200&auto=format&fit=crop&q=80'; // financial charts / markets
  }
  if (t.includes('বিশ্ববিদ্যালয়') || t.includes('গবেষণা') || t.includes('university') || t.includes('শিক্ষা') || t.includes('স্কুল') || t.includes('কলেজ')) {
    return 'https://images.unsplash.com/photo-1532094349884-543bc11b234d?w=1200&auto=format&fit=crop&q=80'; // research lab
  }
  if (t.includes('সিনেমা') || t.includes('ওটিটি') || t.includes('চলচ্চিত্র') || t.includes('সোনার বাংলা') || t.includes('গান') || t.includes('বিনোদন')) {
    return 'https://images.unsplash.com/photo-1489599849927-2ee91cede3ba?w=1200&auto=format&fit=crop&q=80'; // cinema
  }
  if (t.includes('কৃষি') || t.includes('ধান') || t.includes('বোরো') || t.includes('কৃষক') || t.includes('ফসল')) {
    return 'https://images.unsplash.com/photo-1500937386664-56d1dfef3854?w=1200&auto=format&fit=crop&q=80'; // agriculture
  }
  if (t.includes('এআই') || t.includes('কৃত্রিম বুদ্ধিমত্তা') || t.includes('ai') || t.includes('সফটওয়্যার') || t.includes('রোবট')) {
    return 'https://images.unsplash.com/photo-1516321318423-f06f85e504b3?w=1200&auto=format&fit=crop&q=80'; // AI tech
  }

  // Category specific default high quality images
  if (categoryId === 'international') {
    return 'https://images.unsplash.com/photo-1526470608268-f674ce90ebd4?w=1200&auto=format&fit=crop&q=80';
  }
  if (categoryId === 'sports') {
    return 'https://images.unsplash.com/photo-1540747913346-19e32dc3e97e?w=1200&auto=format&fit=crop&q=80';
  }
  if (categoryId === 'economy' || categoryId === 'business') {
...
export function expandToFullJournalisticArticle(
  ...
  const s = cleanSummary.toLowerCase();

  // Check if existing content is an outdated mismatched template (e.g. Iran-US content on a non-Iran title)
  const isMismatchedIranTemplate =
    (cleanBody.includes('হরমুজ প্রণালী') || cleanBody.includes('ইরান-যুক্তরাষ্ট্র')) &&
    !t.includes('ইরান') &&
    !t.includes('হরমুজ') &&
    !t.includes('যুক্তরাষ্ট্র') &&
    !t.includes('আমেরিকা');

  // If the body already has substantial, valid in-depth content and isn't mismatched, preserve it
  if (!isMismatchedIranTemplate && cleanBody.length > 350 && cleanBody.split(/\s+/).length > 50) {
  ...
  // Topic classification and headline-accurate multi-paragraph journalistic generator
  let subHeading1 = 'প্রেক্ষাপট ও সার্বিক পরিস্থিতি';
  let subHeading2 = 'সংশ্লিষ্ট কর্তৃপক্ষের বক্তব্য ও কূটনৈতিক তৎপরতা';
  let subHeading3 = 'আঞ্চলিক ও বৈশ্বিক প্রভাব';
  let subHeading4 = 'বিশ্লেষকদের অভিমত ও ভবিষ্যৎ গতিপথ';
  ...
  const isIranUsWar =
    (t.includes('ইরান') || s.includes('ইরান')) &&
    (t.includes('যুক্তরাষ্ট্র') || t.includes('আমেরিকা') || t.includes('হরমুজ') || t.includes('যুদ্ধ') || t.includes('ক্ষেপণাস্ত্র') || t.includes('সামরিক'));

  const isGazaPeace =
    t.includes('গাজা') || t.includes('ফিলিস্তিন') || t.includes('ইসরায়েল') || t.includes('যুদ্ধবিরতি') || t.includes('রাফা') ||
    s.includes('গাজা') || s.includes('ফিলিস্তিন');

  const isRussiaUkraine =
    t.includes('ইউক্রেন') || t.includes('রাশিয়া') || t.includes('পুতিন') || t.includes('জেলেনস্কি') || t.includes('ন্যাটো') ||
    s.includes('ইউক্রেন') || s.includes('রাশিয়া');

  const isUsPolitics =
    t.includes('হোয়াইট হাউস') || t.includes('বাইডেন') || t.includes('ট্রাম্প') || t.includes('কংগ্রেস') || t.includes('পেন্টাগন') ||
    (t.includes('যুক্তরাষ্ট্র') && !t.includes('ইরান'));

  const isSouthAsia =
    t.includes('ভারত') || t.includes('পাকিস্তান') || t.includes('চীন') || t.includes('দিল্লি') || t.includes('বেইজিং') || t.includes('নেপাল') || t.includes('শ্রীলঙ্কা');

  const isClimateScience =
    t.includes('জলবায়ু') || t.includes('পরিবেশ') || t.includes('মহাকাশ') || t.includes('বিজ্ঞান') || t.includes('নাসা') || t.includes('কপ') || t.includes('কার্বন');
  ...
  if (isIranUsWar) {
    ...
    subHeading1 = 'জাতিসংঘ ও আন্তর্জাতিক নিরাপত্তা পরিষদের অবস্থান';
    subHeading2 = 'মানবিক সহায়তা ও জরুরি ত্রাণ সরবরাহ করিডোর';
    subHeading3 = 'বিশ্বনেতাদের প্রতিক্রিয়া ও কূটনৈতিক মধ্যস্থতা';
    subHeading4 = 'স্থায়ী শান্তি প্রতিষ্ঠা ও ভবিষ্যৎ পুনর্গঠন';

    p1 = `${title}। আন্তর্জাতিক সম্প্রদায়ের অব্যাহত কূটনৈতিক তৎপরতা ও ক্রমবর্ধমান বৈশ্বিক উদ্বেগের প্রেক্ষাপটে সংঘাত বন্ধে নতুন উদ্যোগ গৃহীত হয়েছে। নিউইয়র্কে জাতিসংঘ সদর দপ্তর ও আন্তর্জাতিক ফোরামে সংশ্লিষ্ট পক্ষগুলো অবিলম্বে রক্তপাত বন্ধ ও মানবিক সহায়তা উন্মুক্ত করার বিষয়ে জরুরি ঐকমত্যে পৌঁছেছে।`;
    p2 = `জাতিসংঘ মহাসচিব এবং আন্তর্জাতিক মানবিক সংস্থাগুলো অবিলম্বে বেসামরিক নাগরিকদের সুরক্ষায় নিরাপদ করিডোর প্রতিষ্ঠার ওপর জোর দিয়েছেন। ক্ষতিগ্রস্ত এলাকাগুলোতে ওষুধ, পানীয় জল ও খাদ্যসামগ্রী পৌঁছাতে আন্তর্জাতিক ত্রাণ সংস্থাগুলো পূর্ণ প্রস্তুতি গ্রহণ করেছে।`;
    p3 = `বিশ্বের শীর্ষ কূটনীতিকরা এই উদ্যোগকে স্বাগত জানিয়ে বলেছেন, দীর্ঘমেয়াদী সংঘাত এড়াতে অবিলম্বে একটি স্থায়ী রাজনৈতিক সমাধানের কোনো বিকল্প নেই। মধ্যস্থতাকারী দেশগুলো উভয় পক্ষের সাথে আলোচনা চালিয়ে যাচ্ছে যাতে শান্তি চুক্তির সকল শর্ত যথাযথভাবে পালিত হয়।`;
    p4 = `আন্তর্জাতিক মানবাধিকার পর্যবেক্ষকরা জানিয়েছেন, যুদ্ধবিধ্বস্ত হাসপাতাল ও শিক্ষাপ্রতিষ্ঠান পুনর্নির্মাণে বৈশ্বিক সম্প্রদায়ের কার্যকর সহায়তা প্রয়োজন। আন্তর্জাতিক রেড ক্রস ও বিশ্ব স্বাস্থ্য সংস্থাও ত্রাণ কার্যক্রমে সক্রিয় ভূমিকা পালন করছে।`;
    p5 = `কূটনৈতিক বিশ্লেষকদের মতে, মধ্যপ্রাচ্যে দীর্ঘমেয়াদী স্থিতিশীলতা অর্জনের লক্ষ্যে দুই-রাষ্ট্র সমাধান এবং আন্তর্জাতিক আইনের পূর্ণ বাস্তবায়ন নিশ্চিত করাই এখন সময়ের প্রধান দাবি।`;
  } else if (isRussiaUkraine) {
    subHeading1 = 'যুদ্ধক্ষেত্র ও সামরিক ফ্রন্টলাইনের সর্বশেষ চিত্র';
    subHeading2 = 'ইউরোপীয় নিরাপত্তা ও কূটনৈতিক চাপ';
    subHeading3 = 'বৈশ্বিক অর্থনীতি ও খাদ্য সুরক্ষায় প্রভাব';
    subHeading4 = 'শান্তি আলোচনার সম্ভাবনা ও ভবিষ্যৎ পরিস্থিতি';

    p1 = `${title}। পূর্ব ইউরোপের চলমান ভূরাজনৈতিক সংকটের প্রেক্ষাপটে আন্তর্জাতিক অঙ্গনে নতুন করে নিরাপত্তা উদ্বেগ তৈরি হয়েছে। বিভিন্ন কূটনৈতিক সূত্রে জানা গেছে, সীমান্ত ও কৌশলগত অঞ্চলে সামরিক সক্রিয়তা বৃদ্ধির পর শীর্ষ পরাশক্তিগুলো সার্বিক পরিস্থিতি নিবিড়ভাবে পর্যালোচনা করছে।`;
    p2 = `ইউরোপীয় ইউনিয়ন ও পশ্চিমা দেশগুলোর পক্ষ থেকে আঞ্চলিক নিরাপত্তা ও সার্বভৌমত্ব সুরক্ষায় নতুন পদক্ষেপ ঘোষণা করা হয়েছে। একই সাথে সংঘাতের বিস্তৃতি রোধে জাতিসংঘ সাধারণ পরিষদ ও নিরাপত্তা পরিষদে ধারাবাহিক আলোচনা চলছে।`;
    p3 = `আন্তর্জাতিক অর্থনৈতিক বিশ্লেষকরা বলছেন, এই সংকটের প্রভাব সরাসরি বিশ্ব খাদ্য সরবরাহ ও শক্তি বাজারের ওপর পড়ছে। কৃষ্ণসাগরীয় শস্য চুক্তি ও সার রপ্তানি সচল রাখতে উন্নয়নশীল দেশগুলো কূটনৈতিক উদ্যোগ অব্যাহত রেখেছে।`;
    p4 = `যুদ্ধবিধ্বস্ত সাধারণ মানুষের সহায়তায় আন্তর্জাতিক দাতব্য সংস্থাগুলো নতুন তহবিল বরাদ্দের ঘোষণা দিয়েছে। শরণার্থী পুনর্বাসন ও জরুরি শীতকালীন সহায়তা পৌঁছানোর কাজ পুরোদমে চলছে।`;
    p5 = `আন্তর্জাতিক বিশ্লেষকরা আশা প্রকাশ করেছেন, সামরিক পদক্ষেপের পরিবর্তে অর্থবহ ও ফলপ্রসূ কূটনৈতিক সংলাপের মাধ্যমে খুব শীঘ্রই একটি টেকসই শান্তিচুক্তি সম্ভব হবে।`;
  } else if (isUsPolitics) {
    subHeading1 = 'ওয়াশিংটনের নীতিগত সিদ্ধান্ত ও বৈশ্বিক প্রেক্ষাপট';
    subHeading2 = 'কংগ্রেস ও রাজনৈতিক দলগুলোর পাল্টাপাল্টি প্রতিক্রিয়া';
    subHeading3 = 'আন্তর্জাতিক কূটনীতি ও মিত্র দেশগুলোর মূল্যায়ন';
    subHeading4 = 'অর্থনীতি ও বৈশ্বিক বাণিজ্যে দীর্ঘমেয়াদী প্রভাব';

    p1 = `${title}। যুক্তরাষ্ট্রের সাম্প্রতিক রাজনৈতিক ও প্রশাসনিক সিদ্ধান্তের পর আন্তর্জাতিক অঙ্গনে ব্যাপক আলোচনার জন্ম হয়েছে। হোয়াইট হাউস ও ক্যাপিটল হিল থেকে প্রাপ্ত তথ্যে জানা গেছে, বৈশ্বিক পররাষ্ট্রনীতি ও বাণিজ্যিক ভারসাম্যের ক্ষেত্রে নতুন দিকনির্দেশনা কার্যকর করার প্রস্তুতি চলছে।`;
    p2 = `প্রশাসনের শীর্ষ কর্মকর্তারা জানিয়েছেন, অর্থনৈতিক উন্নয়ন, বৈশ্বিক প্রযুক্তি অংশীদারিত্ব এবং জাতীয় নিরাপত্তা সুসংহত রাখাই তাঁদের মূল লক্ষ্য। এদিকে বিরোধী দলের আইনপ্রণেতারা এই সিদ্ধান্তের বিষয়ে বিস্তারিত ব্যাখ্যা দাবি করেছেন।`;
    p3 = `ইউরোপ, এশিয়া ও মধ্যপ্রাচ্যের মিত্র দেশগুলো ওয়াশিংটনের এই পদক্ষেপের প্রতি নিবিড় নজর রাখছে। বৈশ্বিক মুদ্রা ব্যবস্থা, শুল্ক নীতি এবং আন্তর্জাতিক সামরিক জোটে এর প্রভাব নিয়ে বিশদ বিশ্লেষণ শুরু হয়েছে।`;
    p4 = `অর্থনৈতিক থিঙ্কট্যাঙ্কগুলোর মতে, বিশ্বের বৃহত্তম অর্থনীতির দেশের নীতিগত পরিবর্তনের সরাসরি ঢেউ আছড়ে পড়ে আন্তর্জাতিক শেয়ারবাজার ও কমোডিটি মার্কেটে। ফলে বৈশ্বিক বাণিজ্যে নতুন মেরুকরণ তৈরি হতে পারে।`;
    p5 = `রাজনৈতিক বিশ্লেষকরা মনে করছেন, আসন্ন দিনগুলোতে দ্বিপাক্ষিক আলোচনা ও আন্তর্জাতিক শীর্ষ সম্মেলনের মাধ্যমে এই নীতিমালার চূড়ান্ত রূপরেখা আরও সুস্পষ্ট হয়ে উঠবে।`;
  } else if (isSouthAsia) {
    subHeading1 = 'আঞ্চলিক নিরাপত্তা ও দ্বিপাক্ষিক সম্পর্কের রূপরেখা';
    subHeading2 = 'বাণিজ্য, কানেক্টিভিটি ও অর্থনৈতিক সহযোগিতা';
    subHeading3 = 'সীমান্ত পরিস্থিতি ও কূটনৈতিক আলোচনা';
    subHeading4 = 'দক্ষিণ এশিয়ার টেকসই শান্তি ও সমৃদ্ধি';

    p1 = `${title}। দক্ষিণ এশীয় অঞ্চলের ভূরাজনীতি এবং প্রতিবেশী রাষ্ট্রগুলোর মধ্যকার পারস্পরিক সম্পর্কের ক্ষেত্রে একটি অত্যন্ত তাৎপর্যপূর্ণ অগ্রগতি লক্ষ্য করা গেছে। দুই দেশের কূটনৈতিক প্রতিনিধিরা পারস্পরিক স্বার্থসংশ্লিষ্ট বিষয় নিয়ে উচ্চপর্যায়ের বৈঠক সম্পন্ন করেছেন।`;
    p2 = `বৈঠক শেষে প্রকাশিত যৌথ বিবৃতিতে আঞ্চলিক বাণিজ্য সম্প্রসারণ, যোগাযোগ ব্যবস্থার উন্নয়ন এবং সীমান্তে সৌহার্দ্যপূর্ণ পরিবেশ বজায় রাখার অঙ্গীকার পুনর্ব্যক্ত করা হয়েছে। ভিসা সহজীকরণ ও স্থলবন্দরগুলোর আধুনিকায়ন নিয়েও ইতিবাচক আলোচনা হয়েছে।`;
    p3 = `অর্থনৈতিক বিশেষজ্ঞরা মনে করেন, দক্ষিণ এশিয়ার দেশগুলোর মধ্যে পারস্পরিক বাণিজ্য বৃদ্ধি পেলে তা দারিদ্র্য দূরীকরণ ও শিল্পায়নে বড় ধরনের ভূমিকা রাখবে। সার্ক ও বিমসটেকের মতো আঞ্চলিক জোটগুলোর কার্যকারিতা বৃদ্ধির ওপরও জোর দেওয়া হচ্ছে।`;
    p4 = `পরিবেশ ও পানিসম্পদ বণ্টন সংক্রান্ত যৌথ চ্যালেঞ্জ মোকাবেলায় যৌথ নদী কমিশন এবং জলবায়ু গবেষকদের সমন্বিত গবেষণার আহ্বান জানানো হয়েছে।`;
    p5 = `কূটনীতিকরা আশাবাদ ব্যক্ত করেছেন, শান্তিপূর্ণ সহাবস্থান এবং অর্থনৈতিক অংশীদারিত্বের মাধ্যমে এই অঞ্চল দ্রুতই বৈশ্বিক অর্থনৈতিক প্রবৃদ্ধির মূল কেন্দ্রে পরিণত হবে।`;
  } else if (isClimateScience) {
    subHeading1 = 'বৈজ্ঞানিক গবেষণা ও জলবায়ু পরিবর্তনের তথ্যপ্রমাণ';
    subHeading2 = 'আন্তর্জাতিক জলবায়ু তহবিল ও নবায়নযোগ্য জ্বালানি';
    subHeading3 = 'উন্নয়নশীল দেশগুলোর ঝুঁকি ও ক্ষতিপূরণ দাবি';
    subHeading4 = 'বৈশ্বিক প্রযুক্তি বিপ্লব ও ভবিষ্যৎ রূপরেখা';

    p1 = `${title}। বৈশ্বিক উষ্ণতা হ্রাস ও টেকসই পরিবেশ সুরক্ষায় আন্তর্জাতিক বিজ্ঞানী ও বিশ্বনেতারা একযোগে নতুন অঙ্গীকার ঘোষণা করেছেন। জাতিসংঘের সাম্প্রতিক জলবায়ু প্রতিবেদনে বিশ্বজুড়ে কার্বন নিঃসরণ কমানো ও পরিবেশবান্ধব প্রযুক্তির দ্রুত প্রসারের আহ্বান জানানো হয়েছে।`;
    p2 = `আন্তর্জাতিক পরিবেশ সম্মেলনগুলোতে ঝুঁকিপূর্ণ উপকূলীয় দেশগুলোর জন্য বিশেষ ক্ষতিপূরণ তহবিল (Loss and Damage Fund) কার্যকরভাবে ছাড় করার তাগিদ দেওয়া হয়েছে। সৌর, বায়ু ও জলবিদ্যুৎ খাতে বৈশ্বিক বিনিয়োগ বৃদ্ধি পাচ্ছে।`;
    p3 = `বিজ্ঞানীরা সতর্ক করে বলেছেন, বৈশ্বিক তাপমাত্রা ১.৫ ডিগ্রি সেলসিয়াসের মধ্যে ধরে রাখতে না পারলে প্রাকৃতিক দুর্যোগ ও সমুদ্রপৃষ্ঠের উচ্চতা বৃদ্ধি জনজীবনে অপূরণীয় ক্ষতি ডেকে আনবে।`;
    p4 = `প্রযুক্তি খাতের শীর্ষ উদ্ভাবকরা জানিয়েছেন, পরিবেশবান্ধব ব্যাটারি প্রযুক্তি, কার্বন ক্যাপচার এবং সবুজ হাইড্রোজেনের বাণিজ্যিক ব্যবহারে নতুন সাফল্য অর্জিত হয়েছে।`;
    p5 = `বিশ্বনেতারা একমত হয়েছেন যে আগামী প্রজন্মের জন্য একটি নিরাপদ ও বাসযোগ্য পৃথিবী নিশ্চিত করতে সম্মিলিত বৈশ্বিক প্রতিশ্রুতির পূর্ণ বাস্তবায়নই একমাত্র পথ।`;
  } else if (categoryId === 'international') {
    subHeading1 = 'বৈশ্বিক ভূরাজনীতি ও আন্তর্জাতিক প্রতিক্রিয়া';
    subHeading2 = 'কূটনৈতিক তৎপরতা ও শীর্ষ নেতাদের অবস্থান';
    subHeading3 = 'আন্তর্জাতিক বাণিজ্য ও আঞ্চলিক স্থিতিশীলতায় প্রভাব';
    subHeading4 = 'জাতিসংঘ ও আন্তর্জাতিক সংস্থার পর্যবেক্ষণ';

    p1 = `${title}। আন্তর্জাতিক অঙ্গনে চলমান ভূরাজনৈতিক পরিস্থিতি ও সাম্প্রতিক ঘটনাবলীর প্রেক্ষাপটে বিভিন্ন দেশের কূটনীতিক ও আন্তর্জাতিক বিশ্লেষকদের মধ্যে ব্যাপক আলোচনা শুরু হয়েছে। প্রাপ্ত তথ্যে জানা গেছে, পরিস্থিতির ওপর গভীর নজর রাখছে বিশ্ব সম্প্রদায়।`;
    p2 = `আন্তর্জাতিক সংবাদমাধ্যমের প্রতিবেদন অনুযায়ী, এই ঘটনার প্রভাব সরাসরি আঞ্চলিক শান্তি ও বৈশ্বিক ভারসাম্যের ওপর পড়ছে। সংশ্লিষ্ট দেশের শীর্ষ নেতৃবৃন্দ ও পররাষ্ট্রমন্ত্রীরা পরিস্থিতি পর্যালোচনায় জরুরি বৈঠক আহ্বান করেছেন।`;
    p3 = `জাতিসংঘসহ বিভিন্ন আন্তর্জাতিক সংস্থা ও আঞ্চলিক জোটগুলো সব পক্ষকে শান্তি, সংযম ও পারস্পরিক সহযোগিতার নীতি অনুসরণের আহ্বান জানিয়েছে। কূটনৈতিক মাধ্যমে বিরোধ নিষ্পত্তি এবং সহযোগিতামূলক সম্পর্কের ওপর জোর দেওয়া হয়েছে।`;
    p4 = `অর্থনৈতিক ও রাজনৈতিক বিশ্লেষকরা মনে করছেন, বৈশ্বিক যোগাযোগের এই যুগে এ জাতীয় গুরুত্বপূর্ণ ঘটনাবলী আন্তর্জাতিক বাণিজ্য, পণ্য সরবরাহ ব্যবস্থা এবং কূটনৈতিক নীতিতে তাৎপর্যপূর্ণ প্রভাব বিস্তার করে।`;
    p5 = `বিশ্বের প্রধান প্রধান পরাশক্তিগুলো পরিস্থিতির গতিপ্রকৃতির ওপর সতর্ক নজর রাখছে। আগামী দিনগুলোতে আন্তর্জাতিক ফোরামে এই বিষয়ে আরো সুনির্দিষ্ট দিকনির্দেশনা ও বহুপাক্ষিক পদক্ষেপ গ্রহণ করা হতে পারে বলে ধারণা করা হচ্ছে।`;
    ...
    p1 = `${title}। দেশের যোগাযোগ ব্যবস্থায় আধুনিকতা আনয়ন এবং সাধারণ মানুষের নির্বিঘ্ন যাতায়াত নিশ্চিত করতে সংশ্লিষ্ট উন্নয়ন কার্যক্রম দ্রুত গতিতে এগিয়ে চলছে। সংশ্লিষ্ট প্রকল্পের দায়িত্বশীল কর্মকর্তারা জানিয়েছেন, নির্ধারিত সময়সীমার মধ্যেই সব ধরণের কারিগরি ও অবকাঠামোগত প্রস্তুতি সম্পন্ন করা হবে।`;
    p2 = `প্রকল্প এলাকা ঘুরে দেখা গেছে, অবকাঠামো নির্মাণ, বিদ্যুৎ সঞ্চালন লাইন এবং আধুনিক সিগন্যালিং সিস্টেমের কাজ প্রায় চূড়ান্ত পর্যায়ে রয়েছে। পরিবেশবান্ধব ও দ্রুতগতির এই যোগাযোগ সেবা পুরোপুরি চালু হলে দৈনিক লাখ লাখ মানুষ অল্প সময়ে তাঁদের গন্তব্যে পৌঁছাতে সক্ষম হবেন।`;
    p3 = `ডিএমটিসিএল এবং যোগাযোগ মন্ত্রণালয়ের ঊর্ধ্বতন কর্মকর্তারা নিয়মিত মাঠ পর্যায়ে কাজের অগ্রগতি পরিদর্শন করছেন। কর্মকর্তাদের মতে, নিরাপত্তা এবং জরুরি উদ্ধার ব্যবস্থা নিশ্চিত করতে কঠোর আন্তর্জাতিক মানদণ্ড অনুসরণ করা হচ্ছে।`;
    p4 = `পরিবহন বিশেষজ্ঞদের মতে, এই আধুনিক যোগাযোগ ব্যবস্থার ফলে শুধু যাত্রীদের মূল্যবান কর্মঘণ্টাই বাঁচবে না, বরং পরিবেশ দূষণ উল্লেখযোগ্য হারে হ্রাস পাবে এবং দেশের অর্থনৈতিক কর্মকাণ্ড আরও গতিশীল হবে।`;
    p5 = `নাগরিক সমাজের প্রতিনিধিরা এই উদ্যোগকে স্বাগত জানিয়ে বলেছেন, নিয়মিত রক্ষণাবেক্ষণ এবং সুশৃঙ্খল টিকিট ব্যবস্থাপনার মাধ্যমে এই সেবাকে দীর্ঘমেয়াদে টেকসই রাখতে হবে।`;
    ...
    p2 = `অনুশীলন সেশনে বিশেষ করে কৌশলগত ড্রিল এবং ফিল্ডিং অনুশীলনের ওপর বাড়তি জোর দেওয়া হচ্ছে। খেলোয়াড়দের ব্যক্তিগত ফর্ম ও টিম কম্বিনেশন নিয়ে কোচিং স্টাফরা বিস্তারিত পর্যালোচনা সভা করেছেন।`;
    ...
    p4 = `ক্রীড়া বিশ্লেষকদের মতে, সাম্প্রতিক ম্যাচগুলোতে তরুণ খেলোয়াড়দের দায়িত্বশীল ভূমিকা দলের আত্মবিশ্বাসকে কয়েকগুণ বাড়িয়ে দিয়েছে। অভিজ্ঞ ও তরুণদের চমৎকার সমন্বয়ে দল এখন একটি ভারসাম্যপূর্ণ স্কোয়াডে পরিণত হয়েছে।`;
    p5 = `মাঠের উত্তেজনা ও সমর্থকদের ভালোবাসাকে প্রেরণা হিসেবে নিয়ে দল কাঙ্ক্ষিত বিজয় ছিনিয়ে আনবে—এমনটাই প্রত্যাশা দেশের অগণিত ক্রীড়াপ্রেমী দর্শকের।`;
  } else if (t.includes('প্রযুক্তি') || t.includes('এআই') || t.includes('সাইবার') || t.includes('ইন্টারনেট') || categoryId === 'technology') {
    subHeading1 = 'প্রযুক্তিগত উদ্ভাবন ও ডিজিটাল রূপান্তর';
    subHeading2 = 'সাইবার নিরাপত্তা ও ডেটা সুরক্ষার মানদণ্ড';
    subHeading3 = 'ব্যবহারকারী অভিজ্ঞতা ও শিল্পখাতে প্রয়োগ';
    subHeading4 = 'ভবিষ্যতের প্রযুক্তি বাজার ও সম্ভাবনা';

    p1 = `${title}। তথ্যপ্রযুক্তির দ্রুত পরিবর্তনশীল বিশ্বে নতুন উদ্ভাবন ও ডিজিটাল রূপান্তর জনজীবনে অভূতপূর্ব গতি সঞ্চার করেছে। প্রযুক্তি বিশেষজ্ঞরা জানিয়েছেন, কৃত্রিম বুদ্ধিমত্তা ও ক্লাউড অবকাঠামোর সমন্বয়ে তৈরি এই প্রযুক্তি আধুনিক সেবাকে আরও সহজলভ্য ও নিরাপদ করবে।`;
    p2 = `শিল্প খাতের নেতৃবৃন্দ জানিয়েছেন, স্বয়ংক্রিয় অটোমেশন এবং ডেটা অ্যানালিটিক্স ব্যবহারের ফলে উৎপাদনশীলতা বহুলাংশে বৃদ্ধি পাচ্ছে। একই সাথে তথ্য সুরক্ষায় উচ্চমানের এনক্রিপশন প্রোটোকল বাস্তবায়ন করা হচ্ছে।`;
    p3 = `ব্যবহারকারীদের ফিডব্যাক পর্যালোচনায় দেখা গেছে, নতুন এই প্ল্যাটফর্ম সময় ও শ্রম সাশ্রয়ে অত্যন্ত কার্যকর ভূমিকা পালন করছে। তরুণ উদ্যোক্তারা প্রযুক্তিকে কাজে লাগিয়ে নতুন স্টার্টআপ গড়ে তুলছেন।`;
    p4 = `সাইবার বিশেষজ্ঞরা নিয়মিত নিরাপত্তা অডিট ও সচেতনতা বৃদ্ধির পরামর্শ দিয়ে বলেছেন, প্রযুক্তির ইতিবাচক ব্যবহারই ডিজিটাল অর্থনীতির মূল চালিকাশক্তি।`;
    p5 = `আগামী দিনগুলোতে এই প্রযুক্তি দেশের প্রযুক্তি রফতানি ও মেধা বিকাশে উল্লেখযোগ্য অবদান রাখবে বলে প্রযুক্তিবিদরা দৃঢ় আশাবাদ ব্যক্ত করেছেন।`;
  } else {
    p1 = `${title}। সংশ্লিষ্ট বিষয়ে সর্বশেষ প্রাপ্ত তথ্যে জানা গেছে যে কর্তৃপক্ষ ও দায়িত্বশীল মহল অত্যন্ত গুরুত্বের সাথে সার্বিক পরিস্থিতি পর্যবেক্ষণ করছেন। মাঠ পর্যায়ের তথ্য ও নথিপত্র পর্যালোচনায় বিস্তারিত চিত্র স্পষ্ট হয়ে উঠছে।`;
    p2 = `সূত্রের খবর অনুযায়ী, পূর্বের অভিজ্ঞতার আলোকে প্রশাসন দ্রুত কার্যকর পদক্ষেপ গ্রহণের উদ্যোগ নিয়েছে। স্বচ্ছতা ও নিয়মশৃঙ্খলা বজায় রেখে গৃহীত কর্মসূচিগুলো বাস্তবায়নে কাজ চলছে।`;
    p3 = `দায়িত্বপ্রাপ্ত মুখপাত্র সাংবাদিকদের ব্রিফিংকালে জানান, জনকল্যাণ ও দায়িত্বশীল সেবা নিশ্চিত করাই মূল অগ্রাধিকার। যেকোনো প্রকার অনিয়ম বা শৈথিল্যের বিরুদ্ধে সতর্ক দৃষ্টি রাখা হচ্ছে।`;
    p4 = `বিশ্লেষকদের অভিমত, এ জাতীয় উন্নয়ন দীর্ঘমেয়াদে প্রাতিষ্ঠানিক সক্ষমতা বৃদ্ধিতে সহায়ক হবে। নিয়মিত তদারকি ও উন্মুক্ত মতবিনিময়ের মাধ্যমে সার্বিক কার্যক্রম আরও গতিশীল করা সম্ভব।`;
    p5 = `পরিস্থিতি পুরোপুরি স্বাভাবিক ও কাঙ্ক্ষিত মানে বজায় রাখতে মনিটরিং টিম সার্বক্ষণিক সতর্ক থাকবে বলে নিশ্চিত করা হয়েছে। এ বিষয়ে যেকোনো নতুন তথ্য প্রকাশের সাথে সাথেই বিস্তারিত জানানো হবে।`;
  }

  // If cleanBody had 1-2 good real sentences, merge them smoothly into the opening paragraph
  let firstParagraph = p1;
  if (!isMismatchedIranTemplate && cleanBody.length > 60 && !cleanBody.includes('##')) {
    firstParagraph = `${cleanBody}\n\n${p1}`;
  }
  ...
  const summary = cleanSummary.length > 30 ? cleanSummary : (cleanBody.length > 30 ? cleanBody.slice(0, 240) : p1.slice(0, 240)) + '...';
