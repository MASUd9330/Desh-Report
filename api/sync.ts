...
async function rewriteWithGemini(title: string, description: string, sourceName: string): Promise<GeminiRewrite | null> {
  ...
  const prompt = [
    'তুমি একজন দায়িত্বশীল বাংলা সংবাদ সম্পাদক। নিচের RSS তথ্যের ভিত্তিতে একটি মৌলিক, বিস্তারিত, পাঠকবান্ধব বাংলা সংবাদ প্রতিবেদন তৈরি করো।',
    'লক্ষ্য: একজন পাঠক যেন প্রতিবেদনটি পড়ে ঘটনাটি সম্পর্কে যা কিছু জানা দরকার সবটাই একবারে বুঝে যান — কী ঘটেছে, কারা জড়িত, কোথায় ও কখন ঘটেছে, কেন বা কীভাবে ঘটেছে, প্রেক্ষাপট কী, সংশ্লিষ্টদের প্রতিক্রিয়া (RSS-এ থাকলে), এবং প্রভাব বা পরবর্তী সম্ভাব্য পদক্ষেপ কী।',
    'প্রথম অনুচ্ছেদে মূল ঘটনা ও সবচেয়ে গুরুত্বপূর্ণ তথ্য দাও। এরপর ধারাবাহিকভাবে পটভূমি, বিস্তারিত বিবরণ, সংশ্লিষ্ট পক্ষগুলোর অবস্থান, প্রভাব এবং জানা থাকলে পরবর্তী পদক্ষেপ আলাদা আলাদা অনুচ্ছেদে সাজাও।',
    'সাধারণত ৬০০-৯০০ বাংলা শব্দে ৮-১২টি স্বাভাবিক অনুচ্ছেদ লেখো, যাতে পাঠক বিষয়টি পূর্ণাঙ্গভাবে বুঝতে পারেন। RSS তথ্য সত্যিই সীমিত হলে যতটা সম্ভব বিস্তারিত করো, কিন্তু দৈর্ঘ্য পূরণ করতে বানানো তথ্য যোগ করবে না।',
    'শুধু দেওয়া RSS তথ্য ব্যবহার করবে; কোনো নাম, সংখ্যা, উদ্ধৃতি, স্থান, তারিখ, কারণ বা ঘটনা অনুমান করে যোগ করবে না। একই তথ্য বারবার ঘুরিয়ে-ফিরিয়ে লিখে দৈর্ঘ্য বাড়াবে না, বরং যা আছে তা প্রাসঙ্গিক ব্যাখ্যা দিয়ে সমৃদ্ধ করো।',
    'RSS বাক্য হুবহু কপি করবে না, কিন্তু তথ্যের অর্থ বদলাবে না। শিরোনাম নির্ভুল, সংক্ষিপ্ত এবং clickbait-মুক্ত রাখবে।',
    'content-এ শুধু plain text paragraph থাকবে, HTML নয়। শেষে মতামত, প্রচারণা বা কৃত্রিম filler যোগ করবে না, এবং "আরও পড়ুন" জাতীয় কোনো লাইন নিজে থেকে যোগ করবে না।',
    ...
    try {
      const response = await fetch('https://generativelanguage.googleapis.com/v1beta/models/' + encodeURIComponent(process.env.GEMINI_MODEL || 'gemini-2.0-flash') + ':generateContent?key=' + encodeURIComponent(apiKey), {
        ...
        body: JSON.stringify({
          ...
          generationConfig: { temperature: 0.15, maxOutputTokens: 3200, responseMimeType: 'application/json' }
        })
      });
      if (!response.ok) {
